<form action="https://payments.securetrading.net/process/payments/details" method="POST" class="form-horizontal">
    <fieldset id="payment">
        ...
        <input type="hidden" name="billingpremise" value="<?php echo $order_info['payment_address']; ?>" />
        ...
        <input type="hidden" name="customerpremise" value="<?php echo $order_info['shipping_address']; ?>" />
