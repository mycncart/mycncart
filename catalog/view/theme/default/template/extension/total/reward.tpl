<div class="panel panel-default">
  ...
  <div id="collapse-reward" class="panel-collapse collapse">
    <div class="panel-body">
      ...
      <?php } else { ?>
        <div class="input-group">
        <input type="hidden" name="reward" value="0" placeholder="<?php echo $entry_reward; ?>" id="input-reward" class="form-control" />
        <span class="input-group-btn">
        <input type="submit" value="<?php echo $button_reward_cz; ?>" id="button-reward" data-loading-text="<?php echo $text_loading; ?>"  class="btn btn-primary" />
        </span></div>
	  <?php } ?>
