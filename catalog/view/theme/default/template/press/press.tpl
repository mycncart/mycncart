...
$('#comment').load('index.php?route=press/press/comment&press_id=<?php echo $press_id; ?>');

$('#button-comment').on('click', function() {
	$.ajax({
		url: 'index.php?route=press/press/write&press_id=<?php echo $press_id; ?>',
		type: 'post',
		dataType: 'json',
