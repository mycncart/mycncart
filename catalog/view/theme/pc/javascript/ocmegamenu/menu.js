$(document).ready(function () {
    ...
    $('.mcc-menu .li-top-item .a-top-link').each(function () {
    ...
    $('.horizontal-menu .mega-menu-container').each(function () {
        if($(this).hasClass('right')) {
            if($(this).hasClass('full-width')) {
                ...
                var menu = $('.mcc-menu-bar').offset();
                var dropdown = $(this).parent().offset();

                var dropdownRight = $('.mcc-menu-bar').outerWidth() - dropdown.left;

                var i = (dropdownRight + $(this).outerWidth()) - ($('.mcc-menu-bar').outerWidth());
        ...
        if($(this).hasClass('left')) {
            if($(this).hasClass('full-width') == false) {
                ...
                var i = (dropdown.left + $(this).outerWidth()) - (menu.left + $('.mcc-menu-bar').outerWidth());
    ...
    $('.mobile-menu .mcc-menu-bar').click(function () {
        var effect = $(this).closest('.mcc-menu').find('.menu-effect').val();
        if(effect == "none") {
    ...
    if($('.mcc-menu').hasClass('mobile-menu')) {
