	...
	public function getMethod($address, $total) {
		...
		if ($status) {
			$method_data = array(
				...
				'terms'      => '',
				'sort_order' => $this->config->get('payment_alipay_wap_sort_order')
			);
		}
