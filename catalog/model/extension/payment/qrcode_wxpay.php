	...
	public function getMethod($address, $total) {
		...
		if ($status) {
			$method_data = array(
				...
				'terms'      => '',
				'sort_order' => $this->config->get('payment_qrcode_wxpay_sort_order')
			);
		}
