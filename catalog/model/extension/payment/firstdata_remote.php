					...
					$xml .= '<ipgapi:IPGApiOrderRequest xmlns:v1="http://ipg-online.com/ipgapi/schemas/v1" xmlns:ipgapi="http://ipg-online.com/ipgapi/schemas/ipgapi">';
						$xml .= '<v1:Transaction>';
							...
							$xml .= '<v1:Billing>';
								...
								$xml .= '<v1:Name>' . $order_info['payment_fullname'] . '</v1:Name>';
								$xml .= '<v1:Company>' . $order_info['payment_company'] . '</v1:Company>';
								$xml .= '<v1:Address1>' . $order_info['payment_address'] . '</v1:Address1>';
							...
							$xml .= '<v1:Shipping>';
								$xml .= '<v1:Name>' . $order_info['shipping_fullname'] . '</v1:Name>';
								$xml .= '<v1:Address1>' . $order_info['shipping_address'] . '</v1:Address1>';
