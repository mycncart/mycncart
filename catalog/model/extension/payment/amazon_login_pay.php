...
class ModelExtensionPaymentAmazonLoginPay extends Model {
	...
	public function addAddress($address) {
		$query = $this->db->query("SELECT * FROM `" . DB_PREFIX . "address` WHERE `fullname` = '" . $this->db->escape($address['fullname']) . "' AND `address` = '" . $this->db->escape($address['address']) . "' AND `postcode` = '" . $this->db->escape($address['postcode']) . "' AND `city` = '" . $this->db->escape($address['city']) . "' AND `zone_id` = '" . $this->db->escape($address['zone_id']) . "' AND `country_id` = '" . $this->db->escape($address['country_id']) . "'");
		if (!$query->num_rows) {
	...
	public function editOrder($order_id, $order) {
		$this->db->query("UPDATE `" . DB_PREFIX . "order` SET  payment_fullname = '" . $this->db->escape($order['payment_fullname']) . "', payment_address = '" . $this->db->escape($order['payment_address']) . "', payment_city = '" . $this->db->escape($order['payment_city']) . "', payment_zone = '" . $this->db->escape($order['payment_zone']) . "', payment_zone_id = " . (int)$order['payment_zone_id'] . ", payment_country = '" . $this->db->escape($order['payment_country']) . "', payment_country_id = " . (int)$order['payment_country_id'] . ", payment_postcode = '" . $this->db->escape($order['payment_postcode']) . "' WHERE order_id = " . (int)$order_id);
	}
