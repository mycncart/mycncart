...
class ControllerPaymentCheque extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/cheque')) {
			return $this->load->view($this->config->get('config_template') . '/template/payment/cheque', $data);
		} else {
			return $this->load->view('default/template/payment/cheque', $data);
		}
	}
