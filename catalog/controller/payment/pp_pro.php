...
class ControllerPaymentPPPro extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/pp_pro')) {
			return $this->load->view($this->config->get('config_template') . '/template/payment/pp_pro', $data);
		} else {
			return $this->load->view('default/template/payment/pp_pro', $data);
		}
	}
