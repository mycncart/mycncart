...
class ControllerPressAll extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/press/all')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/press/all', $data));
		} else {
			$this->response->setOutput($this->load->view('default/template/press/all', $data));
		}
