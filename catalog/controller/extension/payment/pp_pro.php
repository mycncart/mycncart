...
class ControllerExtensionPaymentPPPro extends Controller {
	...
	public function send() {
		...
		$request .= '&FIRSTNAME=' . urlencode($order_info['payment_fullname']);
		$request .= '&LASTNAME=' . '';
		...
		$request .= '&STREET=' . urlencode($order_info['payment_address']);
		...
		if ($this->cart->hasShipping()) {
			$request .= '&SHIPTONAME=' . urlencode($order_info['shipping_fullname']);
			...
			$request .= '&SHIPTONAME=' . urlencode($order_info['payment_fullname']);
			$request .= '&SHIPTOSTREET=' . urlencode($order_info['payment_address']);
