...
class ControllerExtensionPaymentSagepayDirect extends Controller {
	...
	public function send() {
		...
		$payment_data['BillingSurname'] = '';
		$payment_data['BillingFirstnames'] = substr($order_info['payment_fullname'], 0, 20);
		$payment_data['BillingAddress1'] = substr($order_info['payment_address'], 0, 100);
