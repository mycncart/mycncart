...
class ControllerExtensionPaymentPPProIframe extends Controller {
	...
	private function constructButtonData($order_info) {
		...
		if ($this->cart->hasShipping()) {
			...
			$s_data['L_BUTTONVAR5'] = 'last_name=';
			$s_data['L_BUTTONVAR6'] = 'address1=' . urlencode($order_info['payment_address']);
			$s_data['L_BUTTONVAR7'] = 'address2=';
		...
		$s_data['L_BUTTONVAR13'] = 'billing_last_name=';
		$s_data['L_BUTTONVAR14'] = 'billing_address1=' . urlencode($order_info['payment_address']);
