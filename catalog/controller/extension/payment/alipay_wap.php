...
class ControllerExtensionPaymentAlipayWap extends Controller {
	public function index() {
		...
		$this->load->helper('alipay_wap/alipay_wap_core');
		
		$this->load->helper('alipay_wap/alipay_wap_rsa');
        ...
        $notify_url =HTTPS_SERVER.'catalog/controller/extension/payment/alipay_wap_callback.php';
		...
		require_once(DIR_SYSTEM.'library/alipay_wap/alipaywapsubmit.php');
		...
		return $this->load->view('extension/payment/alipay_wap', $data);
	...
	public function callback() {
		...
		require_once(DIR_SYSTEM.'library/alipay_wap/alipaywapnotify.php');
