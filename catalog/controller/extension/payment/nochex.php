...
class ControllerExtensionPaymentNochex extends Controller {
	public function index() {
		...
		$data['billing_fullname'] = $order_info['payment_fullname'];

		
		$data['billing_address']  = $order_info['payment_address'] . "\r\n" . $order_info['payment_city'] . "\r\n" . $order_info['payment_zone'] . "\r\n";
		

		$data['billing_postcode'] = $order_info['payment_postcode'];

		if ($this->cart->hasShipping()) {
			$data['delivery_fullname'] = $order_info['shipping_fullname'];
			...
			$data['delivery_fullname'] = $order_info['payment_fullname'];
