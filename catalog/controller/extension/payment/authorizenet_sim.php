...
class ControllerExtensionPaymentAuthorizeNetSim extends Controller {
	public function index() {
		...
		$data['x_address'] = html_entity_decode($order_info['payment_address'], ENT_QUOTES, 'UTF-8') . ' ' . html_entity_decode($order_info['payment_address_2'], ENT_QUOTES, 'UTF-8');
		...
		$data['x_ship_to_address'] = html_entity_decode($order_info['shipping_address'], ENT_QUOTES, 'UTF-8') . ' ' . html_entity_decode($order_info['shipping_address_2'], ENT_QUOTES, 'UTF-8');
