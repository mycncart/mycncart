...
class ControllerExtensionPaymentAlipayDirect extends Controller {
	public function index() {
        ...
        $notify_url = HTTPS_SERVER.'catalog/controller/extension/payment/alipay_direct_callback.php';
		...
		require_once(DIR_SYSTEM.'library/alipay_direct/alipaydtsubmit.php');
	...
	public function callback() {
		...
		require_once(DIR_SYSTEM.'library/alipay_direct/alipaydtnotify.php');
