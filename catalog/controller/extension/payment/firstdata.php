...
class ControllerExtensionPaymentFirstdata extends Controller {
	public function index() {
		...
		$data['bname'] = $order_info['payment_fullname'];
		$data['baddr1'] = substr($order_info['payment_address'], 0, 30);
		$data['baddr2'] = '';
		...
		if ($this->cart->hasShipping()) {
			$data['sname'] = $order_info['shipping_fullname'];
			...
			$data['sname'] = $order_info['payment_fullname'];
			$data['saddr1'] = substr($order_info['payment_address'], 0, 30);
			$data['saddr2'] = '';
