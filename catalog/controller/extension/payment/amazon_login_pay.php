...
class ControllerExtensionPaymentAmazonLoginPay extends Controller {
	...
	public function confirm() {
		...
		if ($this->customer->isLogged()) {
			...
			$order_data['firstname'] = $customer_info['fullname'];
			$order_data['lastname'] = '';
			...
			$order_data['firstname'] = $this->session->data['guest']['fullname'];
			$order_data['lastname'] = '';
		...
		$order_data['payment_firstname'] = $order_data['fullname'];
		...
		$order_data['payment_address'] = $address['address'];
		...
		$order_data['shipping_firstname'] = $address['fullname'];
		$order_data['shipping_lastname'] = '';
		$order_data['shipping_company'] = $address['company'];
		$order_data['shipping_address'] = $address['address'];
	...
	public function setBillingAddress($order_info, $billing_address) {
		...
		$order_info['payment_address'] = $address;
