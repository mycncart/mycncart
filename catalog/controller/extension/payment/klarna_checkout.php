...
class ControllerExtensionPaymentKlarnaCheckout extends Controller {
			...
			if ($country_info) {
				...
				if ($zone || $zones) {
					$this->session->data['shipping_address'] = array(
						...
						'lastname'		 => '',
						'company'		 => null,
						'address'		 => utf8_substr($this->request->post['street_address'], 0, 128),
	...
	public function validation() {
		...
		if ($validate) {
			...
			$order_data = array(
				...
				'payment_lastname'		  => '',
				'payment_address'		  => utf8_substr($request->billing_address->street_address, 0, 128),
				...
				'shipping_address'	  => utf8_substr($request->shipping_address->street_address, 0, 128),
				'shipping_address_2'	  => '',
						...
						if ($order) {
							if ($order->acknowledge()) {
								...
								$order_data = array(
									...
									'payment_lastname'		  => '',
									'payment_address'		  => utf8_substr($order['billing_address']['street_address'], 0, 128),
									...
									'shipping_lastname'		  => '',
									'shipping_address'	  => utf8_substr($order['shipping_address']['street_address'], 0, 128),
									'shipping_address_2'	  => '',
	...
	private function klarnaOrderData($klarna_account) {
		...
		$klarna_order_data['billing_address'] = array(
			...
			'street_address'  => $this->session->data['shipping_address']['address'],
