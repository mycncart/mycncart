...
class ControllerExtensionPaymentAuthorizeNetAim extends Controller {
	...
	public function send() {
		...
		$data['x_address'] = html_entity_decode($order_info['payment_address'], ENT_QUOTES, 'UTF-8');
		...
		if ($order_info['shipping_method']) {
			...
			$data['x_ship_to_address'] = html_entity_decode($order_info['payment_address'], ENT_QUOTES, 'UTF-8');
