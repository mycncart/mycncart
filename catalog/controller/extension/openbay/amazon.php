	...
	public function order() {
		...
		if(isset($customer_info['customer_id'])) {
			...
			$this->db->query("
				...
				SET firstname = '" . $this->db->escape($customer_data['fullname']) . "',
					lastname = '" . $this->db->escape($customer_data['fullname']) . "',
		...
		$order = array(
			...
			'shipping_company' => '',
			'shipping_address' => (string)$order_xml->Shipping->AddressLine1,
			...
			'payment_company' => '',
			'payment_address' => (string)$order_xml->Shipping->AddressLine1,
