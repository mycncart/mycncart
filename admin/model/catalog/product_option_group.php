...
class ModelCatalogProductOptionGroup extends Model {
	public function addProductOptionGroup($data) {
		...
		if (isset($data['product_option_value'])) {
			foreach ($data['product_option_value'] as $product_option_value) {
				$this->db->query("INSERT INTO `" . DB_PREFIX . "product_option_value` SET product_option_group_id = '" . (int)$product_option_group_id . "', product_id = '" . (int)$data['product_id'] . "', option_value_combination = '" . $this->db->escape($data['option_value_combination']) . "', combination_name = '" . $this->db->escape($product_option_value['combination_name']) . "', quantity = '" . (int)$product_option_value['quantity'] . "', cost_price = '" . (float)$product_option_value['cost_price'] . "', price = '" . (float)$product_option_value['price'] . "', points = '" . (int)$product_option_value['points'] . "', weight = '" . (float)$product_option_value['weight'] . "', sku = '" . $this->db->escape($product_option_value['sku']) . "'");
			}
		}
	...
	public function editProductOptionGroup($product_option_id, $data) {
