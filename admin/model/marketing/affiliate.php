...
class ModelMarketingAffiliate extends Model {
	...
	public function approve($affiliate_id) {
		...
		if ($affiliate_info) {
			...
			if (filter_var($affiliate_info['email'], FILTER_VALIDATE_EMAIL)) {
				$mail = new Mail();
