...
class ControllerPaymentQrcodeWxPay extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('payment/qrcode_wxpay', 'token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->link('payment/qrcode_wxpay', 'token=' . $this->session->data['token'], true);
