...
class ControllerPaymentAlipayGuarantee extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('payment/alipay_guarantee', 'token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->link('payment/alipay_guarantee', 'token=' . $this->session->data['token'], true);
