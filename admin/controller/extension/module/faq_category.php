...
class ControllerExtensionModuleFaqCategory extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('module/faq_category', 'token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->link('extension/module/faq_category', 'token=' . $this->session->data['token'], true);
