...
class ControllerExtensionPaymentAlipayWap extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/payment/alipay_wap', 'token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->link('extension/payment/alipay_wap', 'token=' . $this->session->data['token'], true);
