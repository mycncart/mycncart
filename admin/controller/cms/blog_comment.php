...
class ControllerCmsBlogComment extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('cms/blog_comment', 'token=' . $this->session->data['token'] . $url, 'SSL'));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('cms/blog_comment', 'token=' . $this->session->data['token'] . $url, 'SSL')
		);
		
		$data['add'] = $this->url->link('cms/blog_comment/add', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$data['delete'] = $this->url->link('cms/blog_comment/delete', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			$data['blog_comments'][] = array(
				...
				'edit'       => $this->url->link('cms/blog_comment/edit', 'token=' . $this->session->data['token'] . '&blog_comment_id=' . $result['blog_comment_id'] . $url, 'SSL')
			);
		}
		...
		$data['sort_blog'] = $this->url->link('cms/blog_comment', 'token=' . $this->session->data['token'] . '&sort=bd.title' . $url, 'SSL');
		$data['sort_author'] = $this->url->link('cms/blog_comment', 'token=' . $this->session->data['token'] . '&sort=bc.author' . $url, 'SSL');
		$data['sort_status'] = $this->url->link('cms/blog_comment', 'token=' . $this->session->data['token'] . '&sort=bc.status' . $url, 'SSL');
		$data['sort_date_added'] = $this->url->link('cms/blog_comment', 'token=' . $this->session->data['token'] . '&sort=bc.date_added' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('cms/blog_comment', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['blog_comment_id'])) {
			$data['action'] = $this->url->link('cms/blog_comment/add', 'token=' . $this->session->data['token'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('cms/blog_comment/edit', 'token=' . $this->session->data['token'] . '&blog_comment_id=' . $this->request->get['blog_comment_id'] . $url, 'SSL');
		}

		$data['cancel'] = $this->url->link('cms/blog_comment', 'token=' . $this->session->data['token'] . $url, 'SSL');
