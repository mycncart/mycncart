...
class ControllerCmsBlogCategory extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('cms/blog_category', 'user_token=' . $this->session->data['user_token'] . $url, true));
		}
	...
	public function repair() {
		...
		if ($this->validateRepair()) {
			...
			$this->response->redirect($this->url->link('cms/blog_category', 'user_token=' . $this->session->data['user_token'], true));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('cms/blog_category', 'user_token=' . $this->session->data['user_token'] . $url, true)
		);
		
		$data['add'] = $this->url->link('cms/blog_category/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['delete'] = $this->url->link('cms/blog_category/delete', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['repair'] = $this->url->link('cms/blog_category/repair', 'user_token=' . $this->session->data['user_token'] . $url, true);
		...
		foreach ($results as $result) {
			$data['blog_categories'][] = array(
				...
				'edit'        => $this->url->link('cms/blog_category/edit', 'user_token=' . $this->session->data['user_token'] . '&blog_category_id=' . $result['blog_category_id'] . $url, true),
				'delete'      => $this->url->link('cms/blog_category/delete', 'user_token=' . $this->session->data['user_token'] . '&blog_category_id=' . $result['blog_category_id'] . $url, true)
			);
		}
		...
		$data['sort_name'] = $this->url->link('cms/blog_category', 'user_token=' . $this->session->data['user_token'] . '&sort=name' . $url, true);
		$data['sort_sort_order'] = $this->url->link('cms/blog_category', 'user_token=' . $this->session->data['user_token'] . '&sort=sort_order' . $url, true);
		...
		$pagination->url = $this->url->link('cms/blog_category', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['blog_category_id'])) {
			$data['action'] = $this->url->link('cms/blog_category/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('cms/blog_category/edit', 'user_token=' . $this->session->data['user_token'] . '&blog_category_id=' . $this->request->get['blog_category_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('cms/blog_category', 'user_token=' . $this->session->data['user_token'] . $url, true);
		...
		if (isset($this->request->post['blog_category_seo_url'])) {
			...
			$data['blog_category_seo_url'] = $this->model_cms_blog_category->getBlogCategorySeoUrls($this->request->get['blog_category_id']);
		} else {
		...
		if (isset($this->request->post['blog_category_layout'])) {
			...
			$data['blog_category_layout'] = $this->model_cms_blog_category->getBlogCategoryLayouts($this->request->get['blog_category_id']);
		} else {
