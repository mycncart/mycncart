...
class ControllerLocalisationDistrict extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('localisation/district', 'user_token=' . $this->session->data['user_token'] . $url, true));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('localisation/district', 'user_token=' . $this->session->data['user_token'] . $url, true)
		);

		$data['add'] = $this->url->link('localisation/district/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
		$data['delete'] = $this->url->link('localisation/district/delete', 'user_token=' . $this->session->data['user_token'] . $url, true);
		...
		foreach ($results as $result) {
			$data['districts'][] = array(
				...
				'edit'    => $this->url->link('localisation/district/edit', 'user_token=' . $this->session->data['user_token'] . '&district_id=' . $result['district_id'] . $url, true)
			);
		}
		...
		$data['sort_country'] = $this->url->link('localisation/district', 'user_token=' . $this->session->data['user_token'] . '&sort=c.name' . $url, true);
		$data['sort_name'] = $this->url->link('localisation/district', 'user_token=' . $this->session->data['user_token'] . '&sort=d.name' . $url, true);
		$data['sort_zone'] = $this->url->link('localisation/district', 'user_token=' . $this->session->data['user_token'] . '&sort=z.name' . $url, true);
		$data['sort_city'] = $this->url->link('localisation/city', 'user_token=' . $this->session->data['user_token'] . '&sort=ct.name' . $url, true);
		...
		$pagination->url = $this->url->link('localisation/district', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['district_id'])) {
			$data['action'] = $this->url->link('localisation/district/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('localisation/district/edit', 'user_token=' . $this->session->data['user_token'] . '&district_id=' . $this->request->get['district_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('localisation/district', 'user_token=' . $this->session->data['user_token'] . $url, true);
