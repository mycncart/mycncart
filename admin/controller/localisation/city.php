...
class ControllerLocalisationCity extends Controller {
	...
	protected function getList() {
		...
		$data['sort_country'] = $this->url->link('localisation/city', 'user_token=' . $this->session->data['user_token'] . '&sort=c.name' . $url, true);
		$data['sort_name'] = $this->url->link('localisation/city', 'user_token=' . $this->session->data['user_token'] . '&sort=ct.name' . $url, true);
