...
class ControllerSmsChengYu extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('sms/chengyu', 'token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->link('sms/chengyu', 'token=' . $this->session->data['token'], true);

		$data['cancel'] = $this->url->link('extension/sms', 'token=' . $this->session->data['token'], true);
