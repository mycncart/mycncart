...
class ControllerDesignOcmegamenu extends Controller {
    ...
    public function getlist() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('design/megamenu', 'user_token=' . $this->session->data['user_token'] . $url)
        );
        
        $data['add'] = $this->url->link('design/megamenu/add', 'user_token=' . $this->session->data['user_token'] . $url, true);
        $data['delete'] = $this->url->link('design/megamenu/delete', 'user_token=' . $this->session->data['user_token'] . $url, true);
