...
class ControllerModulePressCategory extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('module/press_category', 'token=' . $this->session->data['token'], 'SSL')
		);

		$data['action'] = $this->url->link('module/press_category', 'token=' . $this->session->data['token'], 'SSL');
