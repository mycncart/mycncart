<?php
class ControllerModulePressCategory extends Controller {
	private $error = array();

	public function index() {
		$this->load->language('module/press_category');
		...
		$data['action'] = $this->url->link('module/press_category', 'token=' . $this->session->data['token'], true);
	...
	protected function validate() {
		if (!$this->user->hasPermission('modify', 'module/press_category')) {
