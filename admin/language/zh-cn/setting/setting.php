...
$_['entry_currency']                   	= '货币';
$_['entry_currency_engine']          	= '货币汇率引擎';
...
$_['entry_cookie_status']            	= 'Cookie 政策状态';
$_['entry_gdpr_status']              	= 'GDPR 状态';
...
$_['entry_affiliate_group']            	= '推广会员分组';
$_['entry_affiliate_approval']         	= '推广会员需要审批';
$_['entry_affiliate_auto']             	= '自动添加佣金';
$_['entry_affiliate_commission']       	= '推广会员佣金 (%)';
$_['entry_affiliate']                  	= '推广会员条款';
$_['entry_return']                     	= '退换条款';
...
$_['help_product_category']          	= '在每一个父类中显示商品';
...
$_['help_gdpr_limit']                	= '在确认删除后，设定多少天后自动删除。';
...
$_['help_affiliate_approval']          	= '推广会员注册后自动通过确认。';
$_['help_affiliate_auto']              	= '当订单达到完成状态时，自动分配佣金。';
$_['help_affiliate_commission']        	= '默认推广佣金百分比。';
$_['help_affiliate']                   	= '推广会员和注册时必须同意的条款。';
...
$_['error_extension']                	= '不能上传PHP 文件！';
$_['error_mime']                     	= '不能上传PHP 文件！';
$_['error_log_required']             	= '错误日志文件必填！';
$_['error_log_invalid']              	= '错误日志文件名称无效！';
$_['error_log_extension']            	= '错误日志文件扩展名必须为 .log!';
$_['error_encryption']               	= '加密密钥必须为 32 - 1024 字符！';