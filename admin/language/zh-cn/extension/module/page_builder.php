...
// Text
$_['text_module']              	 		= '模组';
$_['text_success']              		= '成功: 已修改特色模组！';
$_['text_success_import_data']  		= '成功: 已导入主题！';
$_['text_success_duplicate']  			= '成功: 已复制模组！';
$_['text_success_delete']  				= '成功: 已删除模组！';
$_['text_edit']                 		= '编辑页面设计器';
$_['text_create_new_module']			= '创建新模组';

// button
$_['entry_button_save']       			= '保存并退出';
$_['button_save_and_edit']    			= '保存并继续编辑';
$_['button_save_and_new']    			= '保存然后创建新的';
$_['entry_button_cancel']       		= '取消';
$_['button_add_module'] 				= '添加模组';
$_['entry_button_preview']       		= '预览这个';
$_['entry_button_duplicate']       		= '复制这个';
$_['entry_button_delete']       		= '删除这个';
$_['text_module_class']	   				= '模组类';
$_['entry_class_suffix']  				= '模组类前缀';

// Text
$_['text_show_number_col'] 				= '栅格';
$_['text_show_number_col_desc'] 		= '显示列数';
$_['text_design_in'] 					= '屏幕';
$_['text_design_in_desc'] 				= '改变屏幕';
$_['text_import_data'] 					= '导入';
$_['text_import_data_desc'] 			= '导入案例数据';
$_['text_config_row'] 					= '设定行参数';
$_['text_config_col'] 					= '设定列参数';
$_['text_col_num'] 						= '设定列数';
$_['text_row_style'] 					= '行样式';
$_['text_css_class'] 					= '类前缀';
$_['text_bg_color'] 					= '背景颜色';
$_['text_bg_opacity'] 					= '透明度';
$_['text_bg_image'] 					= '背景图片';
$_['text_margin'] 						= '边距(Margin)';
$_['text_padding'] 						= '补白(Padding)';
$_['text_row_section'] 					= '块(Section)';
$_['text_row_section_id'] 				= '块(Section) Id';
$_['text_row_section_class'] 			= '块(Section) 样式';
$_['text_backtolist'] 					= '回到列表';
$_['text_close'] 						= '关闭';
$_['text_save_change'] 					= '保存并继续编辑';
$_['text_save_all'] 					= '保存所有';
$_['text_edit_shortcode'] 				= '编辑短代码(Shortcode)功能';
$_['text_edit_module'] 					= '编辑模组';
$_['text_col_style'] 					= '列样式';
$_['text_add_module'] 					= '添加模组';
$_['text_add_row'] 						= '添加行';

$_['text_select_theme'] 				= '选择主题';
$_['text_theme_start'] 					= 'Start';
$_['text_theme_computer'] 				= '电子(Electronic)';
$_['text_theme_furniture'] 				= '家具(Furniture)';
$_['text_theme_fashion'] 				= '时尚(Fashion)';

$_['text_screen_active'] 				= '选择启用的屏幕';
$_['text_large_col'] 					= '大尺寸设备, 如台式机等';
$_['text_medium_col'] 					= '中等尺寸设备，如笔记本等';
$_['text_small_col'] 					= '小尺寸设备, 如平板电脑等';
$_['text_extra_col'] 					= '极小尺寸设备, 如手机等';
$_['text_large_col_'] 					= '大尺寸设备, 屏幕宽度 >= 1200px';
$_['text_medium_col_'] 					= '中等尺寸设备, 992px <= 屏幕宽度 < 1200px';
$_['text_small_col_'] 					= '小尺寸设备, 768px <= 屏幕宽度 < 992px';
$_['text_extra_col_'] 					= '极小尺寸设备, 屏幕宽度 < 768px';
$_['text_item'] 						= '项(Item)';
$_['text_items'] 						= '项(Items)';
$_['text_col_lg'] 						= 'col-lg-';
$_['text_col_md'] 						= 'col-md-';
$_['text_col_sm'] 						= 'col-sm-';
$_['text_col_xs'] 						= 'col-xs-';
$_['text_col'] 							= '列(Column)';
$_['text_cols'] 						= '列(Columns)';
$_['text_row_container_fluid']			= '满屏宽度(Full width)';
$_['entry_config']						= '配置(Config)';
$_['entry_advanced']					= '高级(Advanced)';
$_['entry_style']						= '样式(Style)';
$_['text_text']							= '文字(Text)';
$_['text_background']					= '背景(Background)';
$_['text_background_type']				= '背景类型(Background Type)';
$_['text_video_type']					= '视频类型(Video Type)';
$_['text_background_none']				= '无';
$_['text_background_color']				= '颜色';
$_['text_background_photo']				= '图片';
$_['text_background_video']				= '视频';
$_['text_video_youtube']				= 'Youtube Url 链接';
$_['text_video_webm']					= 'Webm Url 链接';
$_['text_link_video']					= '视频链接';
$_['text_background_parallax']			= 'Parallax 背景';
$_['text_bg_repeat']					= '重复(Repeat)';
$_['text_background_repeat']			= '标题(Title)';
$_['text_background_horizontal']		= '水平(Horizontal)';
$_['text_background_vertical']			= '垂直(Vertical)';
$_['text_bg_position']					= '位置(Position)';
$_['text_bg_position_left_top']			= '顶部左侧(Left Top)';
$_['text_bg_position_left_center']		= '中部左侧(Left Center)';
$_['text_bg_position_left_bottom']		= '底部左侧(Left Bottom)';
$_['text_bg_position_right_top']		= '顶部右侧(Right Top)';
$_['text_bg_position_right_center']		= '中部右侧(Right Center)';
$_['text_bg_position_right_bottom']		= '底部右侧(Right Bottom)';
$_['text_bg_position_center_top']		= '顶部中部(Center Top)';
$_['text_bg_position_center']			= '中部(Center)';
$_['text_bg_position_center_bottom']	= '底部中部(Center Bottom)';
$_['text_bg_attachment']				= '附加(Attachment)';
$_['text_background_attachment_scroll']	= '滚动(Scroll)';
$_['text_background_attachment_fixed']	= '固定(Fixed)';
$_['text_bg_scale']						= 'Scale';
$_['text_background_scale_auto']		= '自动(Auto)';
$_['text_background_scale_contain']		= 'Contain';
$_['text_background_scale_cover']		= 'Cover';
$_['text_background_scale_initial']		= 'Initial';

$_['text_css_selectors']				= 'CSS 选择器(Selectors)';
$_['text_color']						= '文字颜色(Text Color)';
$_['link_color']						= '链接颜色(Link Color)';
$_['link_hover_color']					= '链接鼠标置上颜色(Link Hover Color)';
$_['heading_color']						= 'Heading Color';
$_['text_responsive_layout']			= '响应式布局(Responsive Layout)';

$_['text_style_width_column'] 			= '列样式宽度(Style Width For Column)';
$_['text_config_shortcode'] 			= '配置短代码(Config Shortcode)';
// Entry
$_['entry_name']       					= '模组名称';
$_['entry_name_desc']       			= '模组名称必填';
$_['entry_head_name']         			= '标题';
$_['entry_head_name_desc']    			= '标题描述';
$_['entry_display_title_module']       	= '显示模组标题';
$_['entry_display_title_module_desc']   = '显示模组标题描述';
$_['entry_status']     					= '状态';
$_['entry_status_desc']     			= '发布/不发布模组';

$_['entry_image']          = '模组图片: ';
$_['entry_link']           = '链接: ';
$_['entry_caption']        = '标题(Caption): ';
$_['entry_layout']         = '布局(Layout): ';
$_['entry_position']       = '位置(Position): ';
$_['entry_status']         = '状态: ';
$_['entry_sort_order']     = '排序: ';
$_['entry_banner_layouts'] = '模组布局: ';

$_['entry_icon_image']     = '模组图片: ';
$_['entry_addition_class'] = '添加类样式(Add class): ';
...
/* List shortcode*/
$_['shortcode_accordion']    		= '折叠';
$_['shortcode_accordion_desc']    	= '折叠样式';
$_['shortcode_box']    				= '框';
$_['shortcode_box_desc']    		= '带有标题的颜色框';
$_['shortcode_buttons']    			= '按钮';
$_['shortcode_buttons_desc']    	= '在此处选择按钮样式';
$_['shortcode_carousel']    		= '旋转';
$_['shortcode_carousel_desc']    	= '利用短代码可以使用图片或商品实现旋转效果';
$_['shortcode_image_carousel']    	= '图片旋转';
$_['shortcode_image_carousel_desc'] = '利用短代码实现图片的旋转';
$_['shortcode_product_carousel']    = '商品旋转';
$_['shortcode_product_carousel_desc']= '利用短代码实现商品的旋转';
$_['shortcode_promotion_box']    	= '促销框';
$_['shortcode_promotion_box_desc']	= '促销框';
...
/* Param shortcode*/
$_['shortcode_all_shortcode']   				= '所有短代码';
$_['shortcode_css_internal']   					= '内部样式';
$_['shortcode_css_internal_desc']   			= '可以为短代码添加内部样式';
$_['shortcode_yt_class']   						= '样式';
$_['shortcode_yt_class_desc']   				= '如果想为该元素添加额外的CSS样式，可以在此处输入，例如：<b title="点击设置为该值" class="yt-generator-set-value">模板样式</b>';

$_['shortcode_name_shortcode']   				= '短代码名称';
$_['shortcode_name_shortcode_desc']   			= '短代码名称';
$_['shortcode_name_shortcode_status']   		= '显示短代码名称';
$_['shortcode_name_shortcode_status_desc']   	= '显示短代码名称';
$_['shortcode_color_background_active']   		= '激活背景颜色';
$_['shortcode_color_background_active_desc'] 	= '激活背景颜色';
$_['shortcode_item_active']   					= '激活项';
$_['shortcode_item_active_desc']  				= '选择项以激活';
$_['shortcode_item_background_active']   		= '激活的项背景';
$_['shortcode_item_background_active_desc']  	= '为所激活的设定背景颜色，例如: 如果项设置为透明，那么<b class="yt-generator-set-value" title="点击设置为该值">transparent</b>/<b class="yt-generator-set-value" title="点击设置为该值">无</b>';
$_['shortcode_item_color_active']   			= '激活项之颜色';
$_['shortcode_item_color_active_desc']  		= '为激活颜色选择一颜色';
...
$_['shortcode_style1']   			= '样式 1';
$_['shortcode_style2']   			= '样式 2';
$_['shortcode_style3']   			= '样式 3';
$_['shortcode_style4']   			= '样式 4';
$_['shortcode_style5']   			= '样式 5';
$_['shortcode_style6']   			= '样式 6';
$_['shortcode_style7']   			= '样式 7';
$_['shortcode_style8']   			= '样式 8';
...
// Javascript
$_['text_change_col_lg']			= '大尺寸设备, 宽屏';
$_['text_change_col_md']			= '中等尺寸设备, 笔记本';
$_['text_change_col_sm']			= '小尺寸设备, 平板电脑';
$_['text_change_col_xs']			= '极小尺寸设备, 手机';
$_['text_java_col']					= '列(Column)';
$_['text_java_cols']				= '列(Columns)';
$_['text_java_textDelete']			= '确定要删除吗？';
$_['text_java_textDuplicate']		= '确定要复制吗？';
$_['text_java_textPreview']			= '确定要预览吗？';
$_['text_java_sortCol']				= '排序列';
$_['text_java_deleteCol']			= '删除列';
$_['text_java_editCol']				= '编辑列';
$_['text_java_duplicateCol']		= '复制列';
$_['text_java_addRow']				= '添加行';
$_['text_java_addModule']			= '添加模组';
$_['text_java_addShortcode']		= '添加短代码';
$_['text_java_row']					= '行';
$_['text_java_sortRow']				= '排序行';
$_['text_java_deleteRow']			= '删除行';
$_['text_java_editRow']				= '编辑行';
$_['text_java_duplicateRow']		= '复制行';
$_['text_java_addCol']				= '添加列';
$_['text_java_sortShortcode']		= '排序短代码';
$_['text_java_deleteShortcode']		= '删除短代码';
$_['text_java_editShortcode']		= '编辑短代码';
$_['text_java_copyShortcode']		= '复制短代码';
$_['text_java_sortModule']			= '排序模组';
$_['text_java_deleteModule']		= '删除模组';
$_['text_java_editModule']			= '编辑模组';
$_['text_java_copyModule']			= '复制模组';
$_['text_java_codeModule']			= '模组代码: ';
$_['text_java_sortItem']			= '排序项';
$_['text_java_deleteItem']			= '删除项';
...
$_['error_permission'] 			= '警告: 无权限修改该模组！';
$_['error_name']       			= '模组名称必须为 3 到 64 字符！';
$_['error_head_name']       	= '模组标题描述必须为 3 到 64 字符！';
$_['error_import_data']         = '警告: 请选择要导入的主题！';