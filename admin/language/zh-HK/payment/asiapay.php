<?php
// Heading
$_['heading_title']					 = 'AsiaPay Payments (Developing)';

// Text
$_['text_payment']					 = 'Payment';
$_['text_success']					 = 'Success: You have modified AsiaPay account details!';
$_['text_edit']                      = 'Edit AsiaPay Payments ';
$_['text_asiapay']				 = '<a target="_BLANK" href="https://www.paydollar.com/"><img src="view/image/payment/paypal.png" alt="AsiaPay Website Payment Pro" title="AsiaPay Website Payment Pro iFrame" style="border: 1px solid #EEEEEE;" /></a>';
