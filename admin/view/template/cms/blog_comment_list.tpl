...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"><button type="button" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-blog-comment').submit() : false;"><i class="fa fa-trash-o"></i></button>
      </div>
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($blog_comment['blog_comment_id'], $selected)) { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php echo $blog_comment['title']; ?></td>
                  <td class="text-left"><?php echo $blog_comment['author']; ?></td>
                  <td class="text-left"><?php echo $blog_comment['status']; ?></td>
                  <td class="text-left"><?php echo $blog_comment['date_added']; ?></td>
                  <td class="text-right"><a href="<?php echo $blog_comment['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=cms/blog_comment&token=<?php echo $token; ?>';
