      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-wx-login" class="form-horizontal">
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="weixin_login_appid" value="<?php echo $weixin_login_appid; ?>" placeholder="<?php echo $entry_appid; ?>" id="entry-appid" class="form-control"/>
              <?php if ($error_appid) { ?>
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="weixin_login_appsecret" value="<?php echo $weixin_login_appsecret; ?>" placeholder="<?php echo $entry_appsecret; ?>" id="entry-appsecret" class="form-control"/>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="weixin_login_status" id="input-status" class="form-control">
                <?php if ($weixin_login_status) { ?>
