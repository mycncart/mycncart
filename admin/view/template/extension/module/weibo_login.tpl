    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-weibo-login" class="form-horizontal">
          ...
          <div class="alert alert-danger"><i class="fa fa-info-circle"></i> <?php echo $text_weibo_open_signup; ?><button type="button" class="close" data-dismiss="alert">&times;</button></div>
                
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="entry-appkey"><?php echo $entry_appkey; ?></label>
            <div class="col-sm-10">
              <input type="text" name="weibo_login_appkey" value="<?php echo $weibo_login_appkey; ?>" placeholder="<?php echo $entry_appkey; ?>" id="entry-appkey" class="form-control"/>
              <?php if ($error_appkey) { ?>
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <input type="text" name="weibo_login_appsecret" value="<?php echo $weibo_login_appsecret; ?>" placeholder="<?php echo $entry_appsecret; ?>" id="entry-appsecret" class="form-control"/>
