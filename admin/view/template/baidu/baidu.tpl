      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-coupon" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" value="<?php echo $baidu_api; ?>" name="baidu_api" placeholder="<?php echo $entry_api; ?>" id="input-api" class="form-control">
              <?php if ($error_api) { ?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="baidu_status" id="input-status" class="form-control">
                <?php if ($baidu_status) { ?>
